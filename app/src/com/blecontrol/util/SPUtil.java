 ...
 */
public class SPUtil {
    public static final String DEVICE_Rename = "DEVICE_Rename";
     ...
     *            私有模式且覆盖原有数据；</br>Context.MODE_APPEND 私有追加不覆盖数据</br>
     *            Context.MODE_WORLD_READABLE
     *            可被其他程序读；</br>Context.MODE_WORLD_WRITEABLE 可被其他程序写</br>
     */
