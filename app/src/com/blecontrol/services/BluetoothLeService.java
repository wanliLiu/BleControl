package com.blecontrol.services;
...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        if (data != null && data.length > 0) {
            ...
            intent.putExtra(Constants.EXTRA_DATA, stringBuilder.toString());
            sendBroadcast(intent);
        }
    }
    ...
    public boolean connect(final String address) {
        ...
        if (mBluetoothDeviceAddress != null && address.equals(mBluetoothDeviceAddress)
                && mBluetoothGatt != null) {
            MLog.d(TAG, "Trying to use an existing mBluetoothGatt for connection.");
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
        	try {
                ...
                if (newState == BluetoothProfile.STATE_CONNECTED) {
                    ...
                    MLog.i(TAG, "Attempting to start service discovery:" +
     ...
     * @return
     */
    public BluetoothGattCharacteristic getWeNeed(UUID service_uuid,UUID characteristic_uuid)
    {
        if (mBluetoothGatt == null)
            return null;
